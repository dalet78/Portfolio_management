...
def check_sma_cross_sma50(df, stock):
    """Analyze SMA crossovers and return a BUY/SELL signal considering SMA50 as trend filter with trade protections."""
    ...
    try:
        ...
        df['SMA50'] = df['close'].rolling(SMA_TREND_PERIOD).mean()  # Trend filter
