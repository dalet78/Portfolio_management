...
def check_sma_cross_candle(df, stock):
    """Analyze SMA crossovers and return a BUY/SELL signal considering trade protections."""
    ...
    try:
        ...
        log.log(f"SMA5: {sma1}, SMA20: {sma2} | Previous SMA5: {prev_sma1}, SMA20: {prev_sma2} | Candle direction: {candle_direction}", stock=stock)
...
#                                     if order_id:
#                                         new_orders.append((order_id, ticker))
#
