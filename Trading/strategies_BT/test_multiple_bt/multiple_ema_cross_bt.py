...
from Trading.strategies_BT.ema_crossing.cents_filter import HOLCStrategy_cents
from Trading.strategies_BT.ema_crossing.ema50_filter import HOLCStrategy_Ema50
from Trading.strategies_BT.ema_crossing.candle_filter import HOLCStrategy_Candle
...
REPORT_FILEPATH = f"{REPORT_DIRECTORY}/backtest_ema_results.csv"
...
strategies = [HOLCStrategy_cents,HOLCStrategy_Candle, HOLCStrategy_Ema50]
